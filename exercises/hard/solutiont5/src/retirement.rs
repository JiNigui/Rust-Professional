use chrono::{NaiveDate, Datelike}; // 引入 chrono 库
...
pub fn retire_time(time: &str, tp: &str) -> String {
    ...
    let birth_date = NaiveDate::parse_from_str(&date_str, "%Y-%m-%d").expect("Invalid date format");
...
impl RetirementCalculator {
    ...
    fn new() -> Self {
        Self {
            policy_start_date: NaiveDate::from_ymd(2025, 1, 1),
        }
    }
